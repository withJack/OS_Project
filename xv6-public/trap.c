...
uint MLFQ_ticks;         // ticks for MLFQ_Boost check.
int timeQuantumPerQ[3] = {1,2,4};   // time quantum for each level
int timeAllotmentPerQ[2] = {5,10};  // time allotment for level 0, 1
...
// check MLFQ queue level, time quantum, time allotment.
void
MLFQ_Check(void)
{
